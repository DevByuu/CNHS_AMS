        ...
        <div class="col-md-6 col-xl-3">
            <div class="stat-card stat-card-orange">
                ...
                <div class="stat-details">
                    ...
                    <div class="stat-value">{{ $lateToday ?? 0 }}</div>
        ...
        <div class="col-lg-8">
            <div class="chart-card">
                <div class="chart-header">
                    <h5 class="chart-title"><i class="bi bi-graph-up me-2"></i>Attendance Trend (Last 7 Days)</h5>
                </div>
...
<style>
    ...
    .activity-text { color:#111827; font-weight:500; margin-bottom:0.25rem; }
    .activity-time { color:#9ca3af; font-size:0.8125rem; }
...
<script>
    ...
    new Chart(trendCtx,{
        ...
        data:{
            ...
            datasets:[
                { label:'Present', data:@json($trendPresent ?? []), borderColor:'#10b981', backgroundColor:'rgba(16,185,129,0.1)', tension:0.4, fill:true },
                { label:'Absent', data:@json($trendAbsent ?? []), borderColor:'#ef4444', backgroundColor:'rgba(239,68,68,0.1)', tension:0.4, fill:true }
            ]
        }
    });
    ...
    new Chart(donutCtx,{
        ...
        data:{
            ...
            datasets:[{
                data:[{{ $presentToday ?? 0 }},{{ $absentToday ?? 0 }},{{ $lateToday ?? 0 }}],
