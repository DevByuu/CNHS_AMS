                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modal">
                                    ...
                                    <input type="text" class="form-control-modal" id="editName" name="name"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modal">
                                    ...
                                    <input type="text" class="form-control-modal" id="editLrn" name="lrn"
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modal">
                                    ...
                                    <input type="email" class="form-control-modal" id="editEmail" name="email">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group-modal">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control-modal" id="editRfid" name="rfid"
                    ...
                    const handleKeyPress = (e) => {
                        ...
                        if (e.key === 'Enter') {
                            ...
                            scanTimeout = setTimeout(() => {
                                if (rfidBuffer.length > 0) {
                                    document.getElementById('editRfid').value = rfidBuffer
                                        .trim();
                                    Swal.close();
                                    Swal.fire({
                                        icon: 'success',
